    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="bg-black/50 border border-white/10 p-6 rounded-2xl backdrop-blur-sm">
            <div className="flex items-center space-x-3">
              <div className="bg-[#7C3AED]/20 p-3 rounded-xl">
                <Trophy className="w-6 h-6 text-[#7C3AED]" />
              </div>
              <div>
                <p className="text-white/60 text-sm">Evaluaciones</p>
          ...
          <Card className="bg-black/50 border border-white/10 p-6 rounded-2xl backdrop-blur-sm">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-white/60 text-sm">Skills Evaluados</p>
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card className="axes-card p-6 rounded-2xl">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <h2 className="text-xl font-bold text-white">Perfil Profesional</h2>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-white/5 rounded-xl">
                    <h4 className="text-white font-medium mb-2">Habilidades Técnicas</h4>
                  ...
                  <div className="p-4 bg-white/5 rounded-xl">
                    <h4 className="text-white font-medium mb-2">Experiencia</h4>
            ...
            <Card className="axes-card p-6 rounded-2xl">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-4 p-4 bg-white/5 rounded-xl">
                  ...
                  <div className="flex-1">
                    <p className="text-white text-sm">Perfil profesional actualizado</p>
                    <p className="text-white/60 text-xs">Hace 10 minutos</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4 p-4 bg-white/5 rounded-xl">
                  ...
                  <div className="flex-1">
                    <p className="text-white text-sm">Cuenta creada en AXES</p>
                    <p className="text-white/60 text-xs">Hace 15 minutos</p>
                  </div>
                </div>
              </div>
            </Card>
          ...
          <div className="space-y-6">
            ...
            <Card className="axes-card p-6 rounded-2xl">
              <div className="text-center space-y-4">
                <div className="bg-gradient-to-r from-[#7C3AED]/20 to-[#1F0A3A]/20 border border-[#7C3AED]/30 rounded-2xl p-6">
