...
import { Building2, Mail, Lock, Eye, EyeOff, ChevronLeft, User } from "lucide-react";
...
export default function CompanyAuthPage() {
  ...
  const { login, signup, isLoading, error } = useCompanyAuth();
          ...
          <Card className="axes-card">
            <CardHeader className="space-y-1 text-center">
              ...
              <CardDescription className="text-axes-text-secondary">
                {isLogin 
                  ? "Accede a tu panel empresarial en AXES"
                  : "Únete a AXES y encuentra el talento ideal"
                }
              </CardDescription>
            </CardHeader>
                ...
                {!isLogin && (
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Building2 className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-axes-text-muted" />
                      <Input
                        name="companyName"
                        type="text"
