      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-4">
            <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
              <TypewriterText
                ...
                delay={500}
                speed={50}
                className="bg-gradient-to-r from-[#7C3AED] to-white bg-clip-text text-transparent"
              />
            </h1>
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white/60 text-sm">React • TypeScript • Next.js</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-white/60 text-sm">12 validaciones</span>
                </div>
              </div>
            </div>
          </Card>
          ...
          <Card className="axes-glass p-6 rounded-2xl">
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                <span className="text-white/60">Nivel de confianza:</span>
          ...
          <Card className="axes-glass p-6 rounded-2xl">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-white/60 text-sm">Proyectos verificados</p>
                <p className="text-2xl font-bold text-white">24</p>
              </div>
              <div>
                <p className="text-white/60 text-sm">Validaciones recibidas</p>
                <p className="text-2xl font-bold text-[#7C3AED]">156</p>
              </div>
              <div>
                <p className="text-white/60 text-sm">Score de confianza</p>
